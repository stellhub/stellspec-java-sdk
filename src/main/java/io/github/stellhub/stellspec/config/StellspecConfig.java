...
public class StellspecConfig {
    ...
    @Builder.Default
    private final boolean insecure = true;

    @Builder.Default
    private final String protocol = "grpc";
    ...
    @Builder.Default
    private final boolean enableCaller = true;

    @Builder.Default
    private final boolean enableStacktrace = true;

    @Builder.Default
    private final Duration batchTimeout = Duration.ofSeconds(5);

    @Builder.Default
    private final Duration exportTimeout = Duration.ofSeconds(3);
    ...
    @Builder.Default
    private final String fallbackFilePath = "logs/stellspec-fallback.log";

    @Builder.Default
    private final RetryConfig retry = RetryConfig.builder().build();
